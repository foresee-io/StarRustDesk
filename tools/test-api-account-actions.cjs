...
assert.equal((dialog.match(/ApiAccountAction\(\{/g) || []).length, 12);
...
console.log('PASS account buttons: reactive labels, selected state, enablement and click guard on all 12 actions');
